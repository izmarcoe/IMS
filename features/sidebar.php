...
<body>
    <div class="bg-dark text-white vh-100 p-3" style="width: 300px;">
        ...
        <div>
            ...
            <a class="sidebar-link fs-5 py-3" href="#productsCollapse" data-bs-toggle="collapse" aria-expanded="false" aria-controls="productsCollapse" onclick="setActive(this)">
                Products
            </a>
            <div class="collapse" id="productsCollapse">
                <a class="sidebar-link fs-5 py-3 ps-4" href="../features/manage_products.php" onclick="setActive(this)">Manage Products</a>
                <a class="sidebar-link fs-5 py-3 ps-4" href="../features/add_product.php" onclick="setActive(this)">Add Products</a>
            </div>
            
            <!-- Sales Collapse Dropdown -->
            <a class="sidebar-link fs-5 py-3" href="#salesCollapse" data-bs-toggle="collapse" aria-expanded="false" aria-controls="salesCollapse" onclick="setActive(this)">
                Sales
            </a>
            <div class="collapse" id="salesCollapse">
                <a class="sidebar-link fs-5 py-3 ps-4" href="../features/manage_sales.php" onclick="setActive(this)">Manage Sales</a>
                <a class="sidebar-link fs-5 py-3 ps-4" href="../features/add_sales.php" onclick="setActive(this)">Add Sales</a>
            </div>
