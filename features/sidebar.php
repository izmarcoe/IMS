...
<div class="bg-dark text-white min-vh-100 p-1" style="width: 300px;">
    <div class="pt-5">
        ...
        <a class="sidebar-link fs-5 py-3 mb-3 d-flex align-items-center <?php echo ($current_page == 'salesPerDay.php' || $current_page == 'salesPerMonth.php' || $current_page == 'salesDateRange.php') ? 'active' : ''; ?>" href="#reportCollapse" data-bs-toggle="collapse" aria-expanded="false" aria-controls="reportCollapse" onclick="setActive(this, event)">
            <img src="../icons/salesreport.svg" style="height:25px; margin-right: 10px;">Sales Report</a>
        <div class="collapse <?php echo ($current_page == 'salesPerDay.php' || $current_page == 'salesPerMonth.php' || $current_page == 'salesDateRange.php') ? 'show' : ''; ?>" id="reportCollapse">
        ...
        <?php if (isset($_SESSION['user_role']) && $_SESSION['user_role'] == 'admin'): ?>
            <a class="sidebar-link fs-5 py-3 mb-3 d-flex align-items-center <?php echo ($current_page == 'forecasting.php') ? 'active' : ''; ?>" href="../features-AI/forecasting.php" onclick="setActive(this)">Predictive Analytics</a>
        <?php endif; ?>
